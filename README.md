# nvim-treesitter-queries-glimmer

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-glimmer/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-glimmer/actions/workflows/validate.yml)

Neovim tree-sitter queries for **glimmer**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-glimmer",
...
- [ ] Changes are scoped to `glimmer` — do not include files for other languages
